...
public class WaveLoadingView extends View {
    ...
    private int mWaveForegroundColor;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Init Wave
        if(!attributes.hasValue(R.styleable.WaveLoadingView_mlv_wave_foreground_color)){
            throw new RuntimeException("Wave foreground color has to be specified!");
        }
        mWaveForegroundColor = attributes.getColor(R.styleable.WaveLoadingView_mlv_wave_foreground_color, DEFAULT_WAVE_COLOR);
        if(!attributes.hasValue(R.styleable.WaveLoadingView_mlv_wave_background_color)){
            throw new RuntimeException("Wave background color has to be specified!");
        }
        mWaveBackgroundColor = attributes.getColor(R.styleable.WaveLoadingView_mlv_wave_background_color, DEFAULT_WAVE_COLOR);

        mCenterColor = attributes.getColor(R.styleable.WaveLoadingView_mlv_center_color, Color.TRANSPARENT);
        ...
        if (mWaveShader != null) {
            ...
            switch (mShapeType) {
                case 0:
                    ...
                    canvas.drawCircle(width / 2f, height / 2f, radius, mCenterPaint);
                ...
                case 1:
                    ...
                    canvas.drawRect(borderWidth, borderWidth, width - borderWidth,
                            height - borderWidth, mCenterPaint);
                    canvas.drawRect(borderWidth, borderWidth, width - borderWidth,
            ...
            if (!TextUtils.isEmpty(mTopTitle)) {
                ...
                canvas.drawText(mTopTitle, (width - top) / 2,
            ...
            if (!TextUtils.isEmpty(mCenterTitle)) {
                ...
                canvas.drawText(mCenterTitle, (width - middle) / 2,
            ...
            if (!TextUtils.isEmpty(mBottomTitle)) {
                ...
                canvas.drawText(mBottomTitle, (width - bottom) / 2,
...
//                wavePaint.setColor(Color.argb((int)(255 * .9), 0x62, 0x6b, 0x7b));
                wavePaint.setColor(mWaveBackgroundColor);
...
//                wavePaint.setColor(Color.argb((int)(255 * .6), 0x7c, 0x8a, 0xa5));
                wavePaint.setColor(mWaveForegroundColor);
    ...
    public void setWaveForegroundColor(int color) {
        mWaveBackgroundColor = color;
...
//        mWaveShader = null;
    ...
    public int getWaveBackgroundColor() {
        return mWaveBackgroundColor;
    }

    public int getWaveForegroundColor() {
        return mWaveForegroundColor;
    }
