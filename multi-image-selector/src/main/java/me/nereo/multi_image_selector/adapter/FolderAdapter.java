...
public class FolderAdapter extends BaseAdapter {
        ...
        if (holder != null) {
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    ...
                    ImageLoadUtils.intoGlobalCenterCrop(f.cover.path, mImageSize, mImageSize, holder.cover);
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            // 显示图片
            ImageLoadUtils.intoGlobalCenterCrop(data.cover.path, mImageSize, mImageSize, cover);
            /*Picasso.with(mContext)
