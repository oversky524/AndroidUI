...
public class SlidingTabLayout extends HorizontalScrollView {
    private onCreateTabView mOnCreateTabView;

    public void setOnCreateTabView(onCreateTabView createTabView){
        mOnCreateTabView = createTabView;
    }
...
//        TextView textView = new TextViewLight(context);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabView == null) {
                if(mOnCreateTabView != null){
                    tabView = mOnCreateTabView.createTabView();
                }else{
    ...
    public interface onCreateTabView{
        View createTabView();
    }
}